...
<!-- Header -->
  ...
  <header class="w3-display-container w3-wide" id="home">
    ...
    <div class="w3-display-left w3-padding-large">
      ...
      <h6><a href="${path}/shop/product/list.do"><button class="w3-button w3-white w3-padding-large w3-large w3-opacity w3-hover-opacity-off" 
      onclick="document.getElementById('subscribe').style.display='block'">New Arrivals</button></a></h6>
    </div>
  </header>
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          ...
          <p class="w3-left"><a href="${path}/shop/product/list2.do"><button class="w3-button w3-white w3-border" 
          onclick="likeFunction(this)" id="#btnBatmanShop"><b><i class="fa fa-thumbs-up"></i> 배트맨 피규어 바로가기</b></button></a></p>
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          ...
          <p class="w3-left"><a href="${path}/shop/product/list3.do"><button class="w3-button w3-white w3-border" 
          onclick="likeFunction(this)"><b><i class="fa fa-thumbs-up"></i> 스파이더맨 피규어 바로가기</b></button></a></p>
